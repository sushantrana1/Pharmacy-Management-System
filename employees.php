...
<body>
  ...
  <form action="add_employee.php" method="POST">
    ...
    <input type="number" name="E_Age" placeholder="Age" required>
     <input type="email" name="E_Mail" placeholder="Email" required><br>
    ...
    <input type="text" name="E_Phno" placeholder="Phone" required>
